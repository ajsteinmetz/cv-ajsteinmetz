...
\pdfbookmark[0]{Andrew James Steinmetz, Ph.D. -- Curriculum Vitae}{cv-top}

\begin{center}
    {\Large\textbf{Andrew James Steinmetz, Ph.D.}}\\[0.5em]
    {\large Curriculum Vitae -- Last Updated September 2026}
\end{center}
...
\begin{tabular}{@{}p{3.8cm} p{4.4cm} p{5.3cm} p{3.0cm}@{}}
    ...
    \midrule
    Academic Professional & School of Physics & Georgia Institute of Technology & {\small Jan~2026--} \\ 
    Global Professor\(^{\rm a}\) & Arizona College of Tech. & Hebei University of Technology & {\small Feb~2024--Jun 2025} \\
    Global Professor\(^{\rm a}\) & Dept. of Physics & University of Arizona              & {\small Nov~2023--Jun 2025} \\
...
\pdfbookmark[1]{Dissertation}{dissertation}
...
Citations = 144; h-index = 8 (\href{https://scholar.google.com/citations?user=fJBK1GIAAAAJ}{Google Scholar}, Sep 2026). See also \href{https://inspirehep.net/authors/1796313}{INSPIRE-HEP} and \href{https://arxiv.org/a/steinmetz_a_1.html}{arXiv}.

\pdfbookmark[2]{Peer-Reviewed Journal Articles}{peer-reviewed-journal-articles}
{\large\textbf{Peer-Reviewed Journal Articles}}

\begin{enumerate}[leftmargin=*,nosep]
    \item \textbf{\href{https://github.com/ajsteinmetz/short-note-qgp}{Steinmetz, A.}}, Rafelski, J. Short note on spin magnetization in QGP, \textit{Eur. Phys. J. Spec. Top.} 234, 2919--2929 (2025), \href{https://doi.org/10.1140/epjs/s11734-025-01625-9}{10.1140/epjs/s11734-025-01625-9}.
...
\pdfbookmark[2]{Book Chapters and Review Articles}{book-chapters-review-articles}
{\large\textbf{Book Chapters \& Review Articles}}

\begin{enumerate}[leftmargin=*,nosep]
    \item Rafelski, J., \textbf{\href{https://github.com/ajsteinmetz/fusion-insights}{Steinmetz, A.}} Science of nuclear fusion: insights and ideas, submitted to \textit{Particles} (2026), \href{https://doi.org/10.48550/arXiv.2609.01366}{10.48550/arXiv.2609.01366}.
    \item Rafelski, J., Birrell, J., Grayson, C., \textbf{\href{https://github.com/ajsteinmetz/thesis-collab-project}{Steinmetz, A.}}, Yang, C. T. Quarks to Cosmos: Particles and Plasma in Cosmological evolution, \textit{Eur. Phys. J. Spec. Top.} 234, 1125--1329 (2025), \href{https://doi.org/10.1140/epjs/s11734-025-01470-w}{10.1140/epjs/s11734-025-01470-w}.
...
\pdfbookmark[2]{Institutional and Technical Reports}{institutional-technical-reports}
{\large\textbf{Institutional \& Technical Reports}}

\begin{enumerate}[leftmargin=*,nosep]
    \item \textbf{Steinmetz, A.} Physics Degree Outcomes from OAE Survey Data, internal report (School of Physics), Georgia Institute of Technology, Atlanta, GA, 2026.
    \item \textbf{Steinmetz, A.} Status and Outlook of PHYS 381/382: Methods in Experimental Physics I/II at ACT HEBUT, internal report (curricular and equipment proposal; \$36,000), University of Arizona, Tucson, AZ, 2025.
...
\pdfbookmark[2]{Works in Progress}{works-in-progress}
{\large\textbf{Works in Progress}}

\begin{enumerate}[leftmargin=*,nosep]
    \item \textbf{Steinmetz, A.}, Labun, L., Formanek, M., Grayson, C., Price, W., Yang, C. T., Rafelski, J. Strong fields in classical and quantum physics, (in preparation, 2026).
%    \item \textbf{Steinmetz, A.}, Rafelski, J. Magnetized primordial heavy-quark plasma, (in preparation, 2026).
%    \item \textbf{Steinmetz, A.}, Yang, C. T., Rafelski, J. Electromagnetic field forcing of dynamic CP-violation in lepton sector, (in preparation, 2026).
%    \item Evans, S., \textbf{Steinmetz, A.} Anomalous magnetic moment in the QCD vacuum, (in preparation, 2026).
\end{enumerate}

\medskip

\pdfbookmark[1]{Conference Presentations and Talks}{conference-presentations-talks}
{\Large\textbf{Conference Presentations \& Talks}}

\pdfbookmark[2]{Talks Presented by Steinmetz}{talks-presented-by-steinmetz}
{\large\textbf{Talks Presented by Steinmetz, A.}}

\begin{enumerate}[leftmargin=*,nosep]
    \item \textbf{Steinmetz, A.} Impact of AI on Education and Professional Careers, \textit{GRIT}, Tampa, FL. October 16, 2025. Invited talk (honorarium). \href{https://doi.org/10.13140/RG.2.2.28318.60486}{10.13140/RG.2.2.28318.60486}
    ...
    \item \textbf{Steinmetz, A.}, Yang, C.~T., Rafelski, J. Primordial Cosmic Magnetism, \textit{SMT 30th Anniversary Steward Observatory Symposium}, University of Arizona, Tucson, AZ, September 22, 2023.\\ \href{http://dx.doi.org/10.13140/RG.2.2.19213.24806}{10.13140/RG.2.2.19213.24806}.
    ...
    \item \textbf{Steinmetz, A.} Relativistic Two-Body Quantum Mechanics, University of Arizona, Tucson, AZ, March 2017.
\end{enumerate}

\pdfbookmark[2]{Talks Co-Prepared by Steinmetz}{talks-co-prepared-by-steinmetz}
...
\pdfbookmark[1]{Grants and Awards}{grants-awards}
...
\pdfbookmark[1]{Teaching Experience}{teaching-experience}
{\Large\textbf{Teaching Experience}}

\textbf{Key:} GT (Georgia Tech), UA (University of Arizona), ACT (Arizona College of Tech.), PCC (Pima Community College)

\pdfbookmark[2]{Faculty Courses at GT}{faculty-courses-gt}
\textbf{Faculty Courses at GT (as Instructor-of-Record)\(^{\rm e}\):}\\
{\normalsize
\begin{tabular}{@{}p{2.5cm} p{6.0cm} p{2.0cm} p{2.0cm} p{3.0cm}@{}}
    ...
    \midrule
    PHYS 4321/2 & Advanced Lab I/II & 2 & 17 & Fall 2026 \\
    PHYS 4604 & Professional Development & 1 & 60 & Fall 2026 \\
    GT 1000 & First-Year Seminar & 1 & 15 & Fall 2026 \\
    PHYS 2212  & Principles of Physics II          & 1 & 163 & Spring 2026 \\
    \midrule
\end{tabular}
}

\pdfbookmark[2]{Faculty Courses at UA and ACT}{faculty-courses-ua-act}
...
\begin{itemize}[leftmargin=*,nosep]
    ...
    \item[\(^{\rm f}\)] Advanced Physics Laboratory (PHYS 381/382), ACT/HEBUT. Developed full-year experimental physics lab curriculum, advising and guidance for the purchasing of +\$14,000 USD (+\textyen 100,000 RMB) in new equipment, and coordinated instruction for 100+ undergraduate students (2024--2025).
...
\pdfbookmark[1]{Academic Service and Associations}{academic-service-associations}
{\Large\textbf{Academic Service \& Associations}}

\pdfbookmark[2]{Institutional Committees and Appointments}{institutional-committees-appointments}
{\large\textbf{Institutional Committees \& Appointments}}

\begin{itemize}[leftmargin=*,nosep]
    \item Member, Academic Faculty Advisory Council (AFAC), GT (2026--present)
    \item Member, Academic Program Committee, School of Physics, GT (2026--present)
    \item Member, Undergraduate Advising and Assessment Committee, School of Physics, GT (2026--present)
...
\pdfbookmark[2]{Professional Service and Membership}{professional-service-membership}
{\large\textbf{Professional Service \& Membership}}

\begin{itemize}[leftmargin=*,nosep]
    \item Mentor, Wildcat Mentor Society, UA (2025--2026)
    ...
    \item Reviewer for \textit{Physical Review Letters}, \textit{Physical Review D}, \textit{Physical Review Research}, \textit{European Physical Journal Plus}, \textit{Modern Physics Letters A}, \textit{International Journal of Modern Physics A}, \textit{Frontiers in Physics}, and \textit{ICPMS 2025}.
\end{itemize}

\pdfbookmark[2]{Laboratory Safety Certifications}{laboratory-safety-certifications}
{\large\textbf{Laboratory Safety Certifications}}

\begin{itemize}[leftmargin=*,nosep]
    \item Cryogenic Materials Safety, UA (2022)
    \item General Laboratory Chemical Safety, UA (2019)
    \item Sealed Source Protection, UA (2018)
\end{itemize}

\pdfbookmark[2]{Public Outreach}{public-outreach}
{\large\textbf{Public Outreach}}

\begin{enumerate}[leftmargin=*,nosep]
    \item \textbf{Steinmetz, A.} (2026, March 25). Accessibility for LaTeX-Based Teaching. \href{https://ajsteinmetz.github.io/mathematics/2026/03/25/latex-accessibility.html}{Link}
...
\pdfbookmark[1]{External and Institutional Press}{external-institutional-press}
{\Large\textbf{External \& Institutional Press}}

\begin{enumerate}[leftmargin=*,nosep]
  \item Vidal, L. C. (2026, April 6). 2026 Frontiers in Science: Advancing Space Exploration, \textit{Georgia Institute of Technology, College of Science}. \href{https://physics.gatech.edu/news/2026-frontiers-science-advancing-space-exploration-0}{Link}; \href{https://www.flickr.com/photos/gtsciences/albums/72177720332868366/}{Flickr}.
